<div class="lead-card pv-card overflow-hidden transition-all relative md:cursor-move"
    ...
    <div class="p-4 cursor-pointer" @click="expanded = !expanded">
        <div class="flex items-start justify-between mb-2">
            ...
            <div class="flex flex-col items-center gap-1">
                <!-- Mobile Drag Handle (above expand arrow) -->
                <div class="drag-handle md:hidden p-1 cursor-move touch-none">
        ...
        <div class="flex items-center gap-2 text-xs flex-wrap">
            ...
            <?php if (!empty($lead['invite_code'])): ?>
            <span class="px-2 py-1 bg-secondary/20 text-secondary rounded-lg font-medium flex items-center gap-1" title="Lead gerado via convite: <?php echo htmlspecialchars($lead['invite_guest_name'] ?? $lead['invite_code']); ?>">
    ...
    <div x-show="expanded" 
        ...
        <div>
            ...
            <div class="mt-4 pt-4 border-t border-white/10">
                <button 
                    @click="if(confirm('Tem certeza que deseja arquivar este lead?')) $root.archiveLead(<?php echo $lead['id']; ?>)"
